...
contract Validators is Params, Ownable {
    ...
    uint256 public unstakeWaitingTime = 7776000;
    ...
    function initialize(address[] calldata vals) external onlyNotInitialized {
        ...
        _transferOwnership(0x34aBfb62ca74acB9dB3799c3f354FDDC69d3b479); //update the owner address before using for system setting
        ...
        _updateGasSettings(0, 100000, 250000000, 0, 0);
        
        _updateParams(30, 50000 ether, 500000 ether, 90);
        ...
        returns (bool)
    {
        ...
        require(stakeTime[staker][validator] + unstakeWaitingTime <= block.timestamp, "You cannot unstake before the time");
    ...
    function _updateParams(uint16 _MaxValidators, uint256 _MinimalStakingCoin, uint256 _minimumValidatorStaking, uint256 _unstakeWaitingTime) internal
    {
      ...
      unstakeWaitingTime = _unstakeWaitingTime * 86400;
    }

    function updateParams(uint16 _MaxValidators, uint256 _MinimalStakingCoin, uint256 _minimumValidatorStaking, uint256 _unstakeWaitingTime) external onlyOwner
    {
      _updateParams(_MaxValidators, _MinimalStakingCoin, _minimumValidatorStaking, _unstakeWaitingTime);
    }
}
